...
namespace Sistema
{
    public partial class crear_pedido_inter : Form
    {
            ...
            if (e.KeyChar == (char)Keys.Enter)
                {
                    ...
                    {
                        e.Handled = true;
                        double valor = (((Convert.ToDouble(textBox8.Text) * Convert.ToDouble(tasa)) * (Convert.ToDouble(textBox13.Text)/100))+ (Convert.ToDouble(textBox8.Text) * Convert.ToDouble(tasa)));
                        double valor2 = (((Convert.ToDouble(textBox8.Text) * Convert.ToDouble(tasa)) * (Convert.ToDouble(textBox15.Text) / 100)) + (Convert.ToDouble(textBox8.Text) * Convert.ToDouble(tasa)));
