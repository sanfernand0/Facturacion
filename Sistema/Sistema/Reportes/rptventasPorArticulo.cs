...
namespace Sistema
{
    public partial class rptventasPorArticulo : Form
    {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string v2 = v + " WHERE numero_prestamo='" + textBox5.Text + "'" + group2 + order2;
            string vvv = v + " WHERE numero_prestamo='" + textBox5.Text + "' AND fecha between Format(#" + dateTimePicker1.Value.ToShortDateString() + "#, 'm/d/yyyy')" + " AND Format(#" + dateTimePicker2.Value.ToShortDateString() + "#, 'm/d/yyyy')" + group2 + order2;
            string vvvv = v + " WHERE fecha between Format(#" + dateTimePicker1.Value.ToShortDateString() + "#, 'm/d/yyyy')" + " AND Format(#" + dateTimePicker2.Value.ToShortDateString() + "#, 'm/d/yyyy')" + group2 + order2;
